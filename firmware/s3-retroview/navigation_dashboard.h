...
// Color definitions — Google Maps day palette (RGB565)
#define NAV_BACKGROUND_COLOR   0xFFFF  // pure white background
#define NAV_TEXT_WHITE         0x18E3  // #1F1F1F dark text (legacy name kept; means primary text)
#define NAV_TEXT_GREEN         0x1A4D  // #188038 success green
#define NAV_TEXT_GRAY          0x6B6D  // #5F6368 mid gray
#define NAV_ACCENT_COLOR       0x14BC  // #1A73E8 Material blue
#define NAV_PROGRESS_COLOR     0xFD60  // #F9AB00 amber
#define NAV_MAP_ROAD_MAIN      0xE71C  // #E0E3E7 light road
#define NAV_MAP_ROAD_SECONDARY 0xCE79  // #CBD0D8 secondary road
#define NAV_MAP_ROUTE          0x14BC  // #1A73E8 blue route line
#define NAV_MAP_SKY            0xF79E  // #F1F3F4 status band background
#define NAV_RADAR_FAR          0x1A4D  // green
#define NAV_RADAR_MID          0xFD60  // amber
#define NAV_RADAR_NEAR         0xF800  // red
